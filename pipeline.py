"""
Cricket Analytics — Hourly Data Pipeline
Runs on GitHub Actions. Reads secrets from environment variables.
...
GITHUB_TOKEN = os.environ["CRICKET_GH_TOKEN"]
GITHUB_USER  = os.environ["CRICKET_GH_USER"]
GITHUB_REPO  = os.environ["CRICKET_GH_REPO"]
BRANCH       = "main"

# ── Step 1: Download from Cricsheet ───────────────────────────────────────
...
downloads = [
    ...
    ("nt20_data", ["nat20_male_csv2.zip", "pknt20_male_csv2.zip"]),
]
...
print("✓ Career stats done")

# ── Step 6: Yearly / venue / opponent / matchup ────────────────────────────
print("\nStep 6 — Yearly & breakdown tables...")
...
print("✓ All breakdown tables done")

# ── Step 7: ML ────────────────────────────────────────────────────────────
print("\nStep 7 — ML similarity, form, scores...")
...
# ── Step 8: Push CSVs to GitHub ───────────────────────────────────────────
print("\nStep 8 — Pushing CSVs to GitHub...")
...
def push_csv(df, filename):
    ...
    payload = {"message": f"Update {filename}", "content": base64.b64encode(csv_bytes).decode(), "branch": BRANCH}
