...
def load():
    return (
        pd.read_csv(gdrive("1Wsg_-7cf7KqP00LhOxT_aiRfC6PeAKCq")),  # cricket_batting_stats
        pd.read_csv(gdrive("19dsGecJoSD58va00nV3qkq5ugdMdbL8d")),  # cricket_bowling_stats
        pd.read_csv(gdrive("1F9Hrk_3mBZn7yTbUa81HoRfqfvJ_4ua_")),  # cricket_batting_by_format
        pd.read_csv(gdrive("1Mlc79NFcw0CtGzFM_O1eytrMgSskbpOA")),  # cricket_bowling_by_format
        pd.read_csv(gdrive("1LYAqZx7f3jqLpfduy49ZGW8FLYzp6QHg")),  # cricket_batting_yearly
        pd.read_csv(gdrive("1RDoE_eLnbMw3gN0Bwm_HfPmzFzZoyU2U")),  # cricket_bowling_yearly
        pd.read_csv(gdrive("1IKT35PQEOWh7vaBVfg2rGnQ4b0cHY5pm")),  # cricket_batting_venue
        pd.read_csv(gdrive("1TnvNkZeEy2iU6MBYzpGsrvGJAPEmW-i_")),  # cricket_batting_opponent
        pd.read_csv(gdrive("1-qxC2EPJQyxiA7OMQW4-3WczV9Wf6C36")),  # cricket_bowling_venue
        pd.read_csv(gdrive("1WUg0kTe0-TttYBBqufB4oAEcmPmkr9VD")),  # cricket_bowling_opponent
        pd.read_csv(gdrive("1Ry64Qb9x-iNwJ7Khx3tFyvcExDT57ATB")),  # cricket_batter_vs_bowler
        pd.read_csv(gdrive("1CFhuErcBCAfu6_8AjknIZcdMd1e8cxqw")),  # cricket_bowler_vs_batter
        pd.read_csv(gdrive("1bqjX2VDAGy8XYz0M7rcDk7GveHkyeZ0U")),  # cricket_bat_form_ratings
        pd.read_csv(gdrive("1gbwjBc7YYsWuhc9cWGCyAiV_l2hM3U0g")),  # cricket_bowl_form_ratings
        pd.read_csv(gdrive("1gbwjBc7YYsWuhc9cWGCyAiV_l2hM3U0g")),  # cricket_bat_similarity
        pd.read_csv(gdrive("1-hraANnICnqHyX2teLLYaSlIDNOT9WMm")),  # cricket_bowl_similarity
        pd.read_csv(gdrive("1XyV4lOYJkZ30zR1LZ2I5mtYK_0A9ThaV")),  # cricket_bat_innings
        pd.read_csv(gdrive("1DMbdq2b6-vSe3Y1_qY7zddDenGZUlqbi")),  # cricket_bowl_innings
    )
