...
def get_wiki(cricsheet_name, search_name):
    ...
    try:
        ...
        debut  = extract_field(wikitext, ["testdebutdate","odidebutdate","t20idebutdate","debutdate","debut_date","international debut"])
        ...
        # fallback: grab description from REST data
